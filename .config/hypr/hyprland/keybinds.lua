...
hl.bind(vars.kbToggleWindowFloating, function()
    ...
    if a then
        hl.dispatch(hl.dsp.window.float({
            action = a.floating and "off" or "on",
...
hl.bind("SUPER + G", hl.dsp.exec_cmd(vars.browser .. " https://github.com/MF-B"))
...
hl.bind(
    "CTRL + SHIFT + ALT + V",
    hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/paste-latest-clipboard.sh"),
    { locked = true }
)
